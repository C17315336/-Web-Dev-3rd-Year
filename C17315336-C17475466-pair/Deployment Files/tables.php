...
<head>
    ...
    <title>CE Listings - User Admin</title>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="useradd.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i class="fas fa-user-plus fa-sm text-white-50"></i>Add User</a>
                    </div>
                            ...
                            echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                        echo "<a href='userread.php?id=". $row['id'] ."' title='View Record' data-toggle='tooltip' class='btn btn-info btn-circle btn-sm'><i class='fas fa-info-circle'></i></a>";
                                        if ($_SESSION["access"] == '0') {
                                            echo "&nbsp;&nbsp;<i class='fas fa-exclamation-triangle'></i>";
                                        }else{
                                            echo "&nbsp;&nbsp;<a href='userupdate.php?id=". $row['id'] ."' title='Update Record' data-toggle='tooltip' class='btn btn-warning btn-circle btn-sm'><i class='fas fa-exclamation-triangle'></i></a>";
                                        }
                                        if ($_SESSION["access"] == '0') {
                                            echo "&nbsp;&nbsp;&nbsp;<i class='fas fa-trash'></i>";
                                        }else{
                                            echo "&nbsp;&nbsp;<a href='userdelete.php?id=". $row['id'] ."' title='Delete Record' data-toggle='tooltip' class='btn btn-danger btn-circle btn-sm'><i class='fas fa-trash'></i></a>";
                                        }       
                                        echo "</td>";
                                    echo "</tr>";
                                }
