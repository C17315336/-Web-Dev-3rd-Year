                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label><strong>Hashed Password</strong></label>
                                        <p class="form-control-static"><?php echo $row["password"]; ?></p>
                                    </div>
                                    <div class="form-group">
                                        <label><strong>Access</strong></label>
                                        <p class="form-control-static"><?php echo $row["access"]; ?></p>
                                    </div>
                                    <div class="form-group">
                                        <label><strong>URL</strong></label>
                                        <p class="form-control-static"><?php echo $row["url"]; ?></p>
                                    </div>
                                    <div class="form-group">
                                        <label><strong>Created</strong></label>
                                        <p class="form-control-static"><?php echo $row["created_at"]; ?></p>
                                    </div>
                                    <p><a href="javascript:history.back()" class="btn btn-primary">Back</a> <button onclick="printFunc()" class="btn btn-default">Print this page</button></p>
                                </div>
                            </div>
