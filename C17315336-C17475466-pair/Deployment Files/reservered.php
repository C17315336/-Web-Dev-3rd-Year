...
<head>
    ...
    <title>CE Listings - Reserved Books</title>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Reserved List</h6>
                        </div>
                        <div class="card-body">
                    ...
                    $sql = "SELECT * FROM reserved JOIN books USING (isbn) WHERE per_id =". $_SESSION["id"]." GROUP BY isbn";
                            ...
                            echo "<table class='table table-bordered' id='dataTable' width='100%' cellspacing='0'>";
                                ...
                                while($row = mysqli_fetch_array($result)){
                                    echo "<tr>";
                                        ...
                                        echo "<td>";
                                        echo "<a href='release.php?id=". $_SESSION["id"] . "&isbn=" . $row['isbn'] . "' class='btn btn-primary'>Remove</a>" ;                                
                                        echo "</td>"; 
                                    echo "</tr>";
                                } 
                            echo "</tbody>";
