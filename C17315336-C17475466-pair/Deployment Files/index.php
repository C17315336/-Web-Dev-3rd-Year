                        ...
                        <div class="col-lg-12 mb-4">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Welcome to our members portal</h6>
                                </div>
                                <div class="card-body">
                                    <p>Hi , Welcome to our free library site , here you can browse through our range of books , reserve and find out information on some of your favourites.Register for a free account today and enjoy all the benefits of a normal library from your own home</p>
                                </div>
                            </div>
